...
void main() {
  ...
  blocTest<WatchlistTvSeriesBloc, WatchlistTvSeriesState>(
    ...
    expect: () =>
        [IsAddedToWatchListTvSeries(true, 'Added to Watchlist TV Series')],
    verify: (bloc) =>
  ...
  blocTest<WatchlistTvSeriesBloc, WatchlistTvSeriesState>(
    ...
    build: () {
      when(mockRemoveWatchlistTvSeries.execute(testTvSeriesDetail))
          .thenAnswer((_) async => Right('Removed to Watchlist TV Series'));
      return watchlistTvSeriesBloc;
    },
  ...
  blocTest<WatchlistTvSeriesBloc, WatchlistTvSeriesState>(
    ...
    act: (bloc) => bloc.add(GetWatchlistStatusEvent(1)),
    expect: () => [IsAddedToWatchListTvSeries(true, '')],
  ...
  blocTest<WatchlistTvSeriesBloc, WatchlistTvSeriesState>(
    ...
    act: (bloc) => bloc.add(SaveWatchlistEvent(testTvSeriesDetail)),
    expect: () => [IsAddedToWatchListTvSeries(false, 'Server Failure')],
    verify: (bloc) =>
        verify(mockSaveWatchlistTvSeries.execute(testTvSeriesDetail)),
  );
  ...
  blocTest<WatchlistTvSeriesBloc, WatchlistTvSeriesState>(
    ...
    act: (bloc) => bloc.add(RemoveWatchlistEvent(testTvSeriesDetail)),
    expect: () => [IsAddedToWatchListTvSeries(true, 'Server Failure')],
    verify: (bloc) =>
        verify(mockRemoveWatchlistTvSeries.execute(testTvSeriesDetail)),
  );
}
